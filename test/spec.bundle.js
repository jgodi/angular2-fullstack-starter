// Borrowed from AngularClass (https://github.com/AngularClass/angular2-webpack-starter)
 ...
 */
var testContext = require.context('./unit', true, /\.spec\.js/);
var appContext = require.context('../public/app', true, /\.spec\.js/);
